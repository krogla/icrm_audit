...
Эмитирование токенов возможно только в периоды краудсейла и только через контракт `IcareumCrowdsale`. Для каждого этапа краудсейла, бонусных программ и резервирования устновлены лимиты эмиссии токенов: 
